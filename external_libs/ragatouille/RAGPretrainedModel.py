...
class RAGPretrainedModel:
    ...
    def _process_metadata(
        ...
        if document_ids is None:
            ...
            if not all(
                isinstance(id, type(document_ids[0])) for id in document_ids
            ):
    ...
    def _process_corpus(
        ...
        pid_docid_map = {
            ...
            for index, item in enumerate(collection_with_ids)
        }
