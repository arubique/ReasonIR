...
class Arguments:
    ...
    def add_model_parameters(self):
        ...
        self.add_argument(
            "--query_maxlen", dest="query_maxlen", default=32, type=int
        )
        self.add_argument(
            "--doc_maxlen", dest="doc_maxlen", default=180, type=int
        )
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument(
            "--resume", dest="resume", default=False, action="store_true"
        )
        self.add_argument(
            "--resume_optimizer",
